...
# Form implementation generated from reading ui file 'kazik.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.reset_on_2 = QtWidgets.QPushButton(self.frame_16)
        self.reset_on_2.setGeometry(QtCore.QRect(75, 20, 65, 30))
        self.reset_on_2.setObjectName("reset_on_2")
...
""")
        ...
        self.timer_bar.setProperty("value", 24)
    ...
    # def init_blinking(self):
    #     self.timer1 = QTimer()
    #     self.timer1.timeout.connect(self.blink)
    #     self.is_green = False
    #
    ...
    #     """Останавливает мигание и возвращает стандартный цвет."""
    #     self.timer1.stop()
    #     self.setGreenButton(self.bt_3min)
    #
    # def blink(self):
    #     """Меняет цвет кнопки (мигание)."""
    #     if self.is_green:
    #         self.setGreenButton(self.bt_3min)
    #     else:
    #         self.setWhiteButton(self.bt_3min)
    #
...
"(online)"))
        ...
        self.reset_on_2.setText(_translate("MainWindow", "Off"))
